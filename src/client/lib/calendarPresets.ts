// Static copy of presets for client-side use (avoids a fetch on every isNonWorkingDay call).
// These mirror src/server/lib/calendar.ts.

export const CALENDAR_PRESETS_STATIC = [
  {
    country: 'uy',
    name: 'Uruguay',
    weekendDays: [0, 6],
